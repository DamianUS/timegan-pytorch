...
def generate_experiment_command(module, num_layers, hidden_dim, emb_epochs, sup_epochs, gan_epochs, learning_rate,
    ...
    experiment_save_dir = f'~/experiments/timegan-pytorch/alibaba2018/ecms-experiments-pytorch/num_layers-{num_layers}-hidden_dim-{hidden_dim}-batch_size-{batch_size}'
    return f'python main.py --device cuda --module {module} --num_layers {num_layers} --hidden_dim {hidden_dim} --emb_epochs {emb_epochs} ' \
